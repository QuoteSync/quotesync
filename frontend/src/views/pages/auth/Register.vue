      ...
      <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
        <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
          <div class="text-center mb-8">
            <!-- Aquí puedes colocar tu logo o SVG -->
          ...
          <div>
            ...
            <Password id="password" v-model="password" placeholder="Enter password" :toggleMask="true" class="mb-4" fluid :feedback="false"></Password>
            ...
            <Password id="confirmPassword" v-model="confirmPassword" placeholder="Confirm password" :toggleMask="true" class="mb-4" fluid :feedback="false" @keyup.enter="register"></Password>

            <div class="flex items-center justify-between mt-2 mb-8 gap-8">
              <!-- Aquí podrías agregar un checkbox para aceptar términos, si lo deseas -->
            </div>
            <!-- Botón que llama a la función de registro -->
