<template>
    <svg viewBox="0 0 46.195 46.195" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="23.0975" cy="23.0975" r="22" fill="var(--surface-card)" stroke="var(--primary-color)" stroke-width="2"/>
        <g transform="translate(9, 9) scale(0.6)">
            <path d="M35.765,8.264c-5.898,0-10.555,4.782-10.555,10.68s4.844,10.68,10.742,10.68
            ...
            <path d="M10.75,8.264c-5.898,0-10.563,4.782-10.563,10.68s4.84,10.68,10.739,10.68
