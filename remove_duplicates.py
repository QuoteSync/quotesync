...
from api.models import Quote  # Using the correct app name 'api'
...
# Set up Django
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'backend.backend.settings')  # Adjust with your project settings
django.setup()
